...
/* Este componente se encarga del Login, en un principio detecta si el usuario ya esta autenticado
Si lo esta, lo redirecciona al blog.
Captura los valores que esta escribiendo el usuario y una vez se envian los datos
se realiza un post, si se resuelve correctamente redirecciona al usuario al blog
de lo contrario saltara un mensaje de error diciendo que el usuario no existe*/
