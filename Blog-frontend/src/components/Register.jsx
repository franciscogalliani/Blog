...
/* Este componente es muy similar al componente Login, captura los datos de la misma manera y realiza algunas verificaciones
como que las contraseñas coincidan o que el usuario no exista ya en la base de datos.
Si se resuelve correctamente redirecciona al usuario a loguearse */
...
function Register({ isAuth }) {
  ...
  const registerHandler = (e) => {
    e.preventDefault();
    if (!register.user || !register.password || !register.confirmPassword)
